...
import 'package:naqde_user/features/home/widgets/recent_transaction_widget.dart';
import 'package:naqde_user/features/home/widgets/show_case/showcaseview.dart';
import 'package:naqde_user/features/home/widgets/welcome_bottom_sheet.dart';
...
import 'package:naqde_user/features/home/widgets/home_app_bar_widget.dart';
import 'package:naqde_user/features/home/widgets/theme_one_widget.dart';
import 'package:naqde_user/features/home/widgets/linked_website_widget.dart';
import 'package:naqde_user/features/home/widgets/theme_two_widget.dart';
import 'package:naqde_user/features/home/widgets/theme_three_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadData(BuildContext context, bool reload) async {
    ...
    if(transactionHistoryController.recentTransactionList == null || reload) {
      transactionHistoryController.getRecentTransactionList();
    }
    if(transactionHistoryController.transactionModel == null || reload) {
      transactionHistoryController.getTransactionData(1, reload: reload);
    }
    ...
    Get.find<FavNumberController>().getFromLocalStorage();
