...
class ShareStatementWidget extends StatefulWidget {
  ...
  final String? charge;
  final String? trxId;
  const ShareStatementWidget({super.key,required this.amount, required this.transactionType, required this.contactModel,required this.charge,required this.trxId});
  ...
  Widget build(BuildContext context) {
    ...
    final splashController = Get.find<SplashController>();
        return Screenshot(
          ...
          child: Scaffold(
            backgroundColor: context.customThemeColors.screenShortBackgroundColor,
            body: Center(
              child: Container(
                height: size.height,
                width: size.width,
