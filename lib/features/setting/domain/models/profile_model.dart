...
class ProfileModel {
  ProfileModel({
    ...
    this.totalWithdrawMoneyAmount,
    this.totalSendMoneyAmount,
    this.totalCashOutAmount,
  ...
  double? totalWithdrawMoneyAmount;
  double? totalSendMoneyAmount;
  ...
  factory ProfileModel.fromJson(Map<String, dynamic> json) => ProfileModel(
    ...
    totalWithdrawMoneyAmount: double.tryParse('${json["total_withdraw_money_amount"]}'),
    totalSendMoneyAmount: double.tryParse('${json["total_send_money_amount"]}'),
    totalCashOutAmount: double.tryParse('${json["total_cash_out_amount"]}'),
...
class TransactionLimit {
  ...
  factory TransactionLimit.fromJson(Map<String, dynamic> json) => TransactionLimit(
    ...
    dailyAddMoneyAmount: double.tryParse('${json["daily_add_money_amount"]}'),
    monthlyAddMoneyAmount: double.tryParse('${json["monthly_add_money_amount"]}'),

    dailySendMoneyCount: int.parse('${json["daily_send_money_count"]}'),
    monthlySendMoneyCount: int.parse('${json["monthly_send_money_count"]}'),
    dailySendMoneyAmount: double.tryParse('${json["daily_send_money_amount"]}'),
    monthlySendMoneyAmount: double.tryParse('${json["monthly_send_money_amount"]}'),

    dailyCashOutCount: int.parse('${json["daily_cash_out_count"]}'),
    monthlyCashOutCount: int.parse('${json["monthly_cash_out_count"]}'),
    dailyCashOutAmount: double.tryParse('${json["daily_cash_out_amount"]}'),
    monthlyCashOutAmount: double.tryParse('${json["monthly_cash_out_amount"]}'),
    ...
    dailySendMoneyRequestAmount: double.tryParse('${json["daily_send_money_request_amount"]}'),
    monthlySendMoneyRequestAmount: double.tryParse('${json["monthly_send_money_request_amount"]}'),
    ...
    dailyWithdrawRequestAmount: double.tryParse('${json["daily_withdraw_request_amount"]}'),
    monthlyWithdrawRequestAmount: double.tryParse('${json["monthly_withdraw_request_amount"]}'),
