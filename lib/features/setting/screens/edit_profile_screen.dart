...
import 'package:naqde_user/features/auth/widgets/sign_up_input_widget.dart';
...
import 'package:naqde_user/common/widgets/custom_small_button_widget.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    Get.find<EditProfileController>().setGender(profileController.userInfo!.gender ?? 'Male', isUpdate: false) ;
                  ...
                  Stack(clipBehavior: Clip.none, children: [
                    GetBuilder<CameraScreenController>(builder: (imageController){
                      ...
                      GetBuilder<ProfileController>(builder: (proController){
                        return proController.isLoading ? const SizedBox() : Container( height: 130,width: 130,
                    ...
                    Positioned(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.camera_alt_outlined, size: Dimensions.paddingSizeLarge, color: Theme.of(context).cardColor),
                        ),
                      ),
                    ),
                  ]),
