      ...
      child: Padding(
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: widget.isAccept ? context.customThemeColors.accept : Theme.of(context).colorScheme.error.withValues(alpha:0.7) , shape: BoxShape.circle),
                ...
                children: [
                  ...
                  !reqController.isLoading? Row(
                    children: [
                      ...
                      Expanded(child: CustomButtonWidget(buttonText: 'yes'.tr, onTap: widget.onYesPressed,color: context.customThemeColors.accept,)),
                    ],
