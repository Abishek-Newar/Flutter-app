...
import 'package:naqde_user/common/widgets/custom_selection_dialog.dart';
...
class CodePickerWidget extends StatefulWidget {
  ...
  final bool showFlagBackgroundColor;
  final Color? flagBackGroundColor;
  final double? borderRadius;

  const CodePickerWidget({super.key,
    this.onChanged,
    this.onInit,
    ...
    this.showFlagBackgroundColor = true,
    this.flagBackGroundColor,
    this.borderRadius,
  });
  @override
      ...
      child = InkWell(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            Container(
              padding: widget.showFlagBackgroundColor ? const EdgeInsets.all(Dimensions.paddingSizeSmall).copyWith(left: Dimensions.paddingSizeDefault, right: 0) : null,
              decoration: BoxDecoration(
                  color: widget.showFlagBackgroundColor ? widget.flagBackGroundColor ?? Theme.of(context).hintColor.withValues(alpha: 0.04) : Colors.transparent,
                  borderRadius:  BorderRadius.only(
                    topLeft: Get.find<LocalizationController>().isLtr ? Radius.circular(widget.borderRadius ?? Dimensions.radiusSizeSmall) : Radius.zero,
                    bottomLeft: Get.find<LocalizationController>().isLtr ? Radius.circular(widget.borderRadius ?? Dimensions.radiusSizeSmall) : Radius.zero,
                    topRight: Get.find<LocalizationController>().isLtr ? Radius.zero : Radius.circular(widget.borderRadius ?? Dimensions.radiusSizeSmall),
                    bottomRight: Get.find<LocalizationController>().isLtr ? Radius.zero : Radius.circular(widget.borderRadius ?? Dimensions.radiusSizeSmall),
                  )
              ),
              child: Row(children: [
